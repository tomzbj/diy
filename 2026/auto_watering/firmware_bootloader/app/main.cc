...
ZUART4 u1(cbs_u1, 32768);
ZBOOT zboot(cbs_zboot, 0x0800'0000, 1024 * 1024, 2048, 30000);

constexpr int jump_delay = 2000;    // wait 2000ms and then jump to app
static uint8_t packet_buf[31000];
