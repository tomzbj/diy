...
// high-level ops
    ...
    void write_regs(uint8_t reg, const uint8_t* data, int count) const;
    void read_regs(uint8_t reg, uint8_t* data, int count) const;
    void read_raw(uint8_t reg, uint8_t* data, int count) const;
